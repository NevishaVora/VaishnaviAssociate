     ...
     <section className="mainContainer py-8 sm:py-10 md:py-20">
        ...
        <div className="mt-20 space-y-12">
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-[20px] md:rounded-[32px] border border-[#e6e8ed] bg-[--white] p-6 md:p-8 shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
              <h2 className="text-2xl md:text-3xl font-semibold text-[--secondary-theme-color] mb-4">
                What is ITR Filing?
              </h2>
              <p className="text-[--gray] leading-6 md:leading-8">
          ...
          <div className="rounded-[20px] md:rounded-[32px] border border-[#e6e8ed] bg-[--white] p-6 md:p-8 shadow-[0_15px_50px_rgba(0,0,0,0.08)]">
            ...
            <p className="text-[--gray] leading-6 md:leading-8 mb-6 text-sm md:text-base">
              To complete your ITR filing, gather the documents listed below. Vaishnavi Associates will help you organize everything and submit the return accurately.
            </p>
